    ...
    onEnter(other) {
        this.#components.forEach((c) => {
            try {
                ...
                console.log("An error happened in onEnter - " + c.constructor.name + ": " + ex);
            }
        });
    }
    ...
    onOverlap(other) {
        this.#components.forEach((c) => {
            try {
                ...
                console.log("An error happened in onOverlap - " + c.constructor.name + ": " + ex);
            }
        });
    }
    ...
    onDestroy() {
        this.#components.forEach((c) => {
            try {
                ...
                console.log("An error happened in onDestroy - " + c.constructor.name + ": " + ex);
            }
        });
    }
    ...
    onExit(other) {
        this.#components.forEach((c) => {
            try {
                ...
                console.log("An error happened in onExit - " + c.constructor.name + ": " + ex);
            }
        });
    }
        ...
        this.#components.forEach((c) => {
            if (c.isActive == true) {
                try {
                    ...
                    console.log("An error happened in onDraw - " + c.constructor.name + ": " + ex);
                }
            }
        });
    }
