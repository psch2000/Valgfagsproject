...
export class DrawIconTest extends Component{

    constructor(path, useOrigen = false, useRotation = false, rotationAngle = 0){
        super();
        this.img= new Image();
        this.img.src = path;
    ...
    onDraw(context){
        ...
        // let originalPosition = this.transform.position.copy();
        ...
        if (this.useRotation) {
            ...
            // console.log("rotate" + this.rotationAngle)
        }
        ...
        if (this.useRotation) {
            console.log("use rotation and origin")
