...
export class TowerType{
        ...
        static yellowTower = new TowerType("Bomb Shooter", 100, "./images/sprite_canonball.png", 445, "./images/sprite_monkey5.png", "./images/sprite_greymonkey5.png", 25, 1, new SingleFirePatternBuilder());
        static orangeTower = new TowerType("Super Monkey", 180, "./images/sprite_laser.png", 2125, "./images/sprite_monkey6.png", "./images/sprite_greymonkey6.png", 25, 1, new SuperMonkeyFirePattern());
