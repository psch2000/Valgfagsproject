...
export class TowerType{
        ...
        static redTower = new TowerType("Boomerang", 120, "./images/sprite_ball_tennis.png", 275, "./images/sprite_monkey2.png", "./images/sprite_greymonkey2.png", 25, 1, new TrippleFirePatternBuilder());
        ...
        static yellowTower = new TowerType("Bomb Shooter", 100, "./images/sprite_ball_tennis.png", 445, "./images/sprite_monkey5.png", "./images/sprite_greymonkey5.png", 25, 1, new TrippleFirePatternBuilder());
        static orangeTower = new TowerType("Super Monkey", 180, "./images/sprite_ball_baseball.png", 2125, "./images/sprite_monkey6.png", "./images/sprite_greymonkey6.png", 25, 1, new TackShooterFirePatternBuilder());
