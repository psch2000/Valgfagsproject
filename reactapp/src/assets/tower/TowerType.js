...
export class TowerType{
        ...
        static yellowTower = new TowerType("Bomb Shooter", 100, "./images/sprite_canonball.png", 445, "./images/sprite_monkey5.png", "./images/sprite_greymonkey5.png", 25, 1, new CanonFirePatternBuilder());
