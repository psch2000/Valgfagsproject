...
export class TowerType{
        ...
        static greenTower = new TowerType("Ice Monkey", 80, "./images/sprite_ball_tennis.png", 450, "./images/sprite_monkey3.png", "./images/sprite_greymonkey3.png", 25, 1, null, true, false);
    ...
    constructor(name, range, projectileImagePath, price, imagePath, dsbImage, size, damage, firePatternBuilder, useArea = false, useRotation = true){
        this.name = name;
        this.radius = size;
        this.range = range;
